...
public class AvlTreeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    int ScreenWidth;
    ...
    class SeekBarClass implements OnSeekBarChangeListener {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            try {
                AvlTreeActivity.this.dt.resume();
            } catch (Exception e) {
            }
        }
        ...
        public void onStartTrackingTouch(SeekBar seekBar) {
            try {
                AvlTreeActivity.this.dt.pause();
            } catch (Exception e) {
            }
        }

        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            AvlTreeActivity.this.speed = (((double) progress) / ((double) AvlTreeActivity.this.ss.getMax())) * 100.0d;
        }
    }
...
//                }
            ...
            try {
                ...
                AvlTreeActivity.this.undoStack.push(AvlTreeActivity.this.rbt.clone());
                AvlTreeActivity.this.print = "";
                AvlTreeActivity.this.rbn = null;
                int k = Integer.parseInt(AvlTreeActivity.this.editText1.getText().toString());
                editText1.setText("");
                AvlTreeActivity.this.rbt.insert(k);
                AvlTreeActivity.this.animate = false;
                AvlTreeActivity redBlackTreeActivity = AvlTreeActivity.this;
                redBlackTreeActivity.print += "Inserted " + k;
                check.setText("Inserted " + k);
                AvlTreeActivity.this.setWidth();
                AvlTreeActivity.this.setDimension();
            } catch (Exception ex) {
                ex.printStackTrace();
            }
            AvlTreeActivity.this.dt.resume();
    ...
    class DeleteClass implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                ...
                int k = Integer.parseInt(AvlTreeActivity.this.editText1.getText().toString());
                editText1.setText("");
                AvlTreeActivity.this.rbt.delete(k);
                if (AvlTreeActivity.this.print == "") {
                    AvlTreeActivity.this.print = "Key " + k + " deleted from tree.";
                    check.setText("Key " + k + " deleted from tree.");

                } else {
                    AvlTreeActivity.this.undoStack.pop();
                }
                AvlTreeActivity.this.rbn = null;
                AvlTreeActivity.this.setWidth();
                AvlTreeActivity.this.setDimension();
    ...
    class FindClass implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                AvlTreeActivity.this.print = "";
                AvlTreeActivity.this.rbn = null;
                AvlTreeActivity.this.found = false;
                int k = Integer.parseInt(AvlTreeActivity.this.editText1.getText().toString());
                AvlTreeActivity.this.found = AvlTreeActivity.this.rbt.search(k);
                if (AvlTreeActivity.this.print == "" && AvlTreeActivity.this.found) {
                    AvlTreeActivity.this.print = "Key " + k + " found.";
                    check.setText("Key " + k + " found.");
                } else {
                    AvlTreeActivity.this.print = "Key " + k + " not found";
    ...
    class UndoClass implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                AvlTreeActivity.this.print = "";
                AvlTreeActivity.this.rbn = null;
                AvlTreeActivity.this.undo();
                AvlTreeActivity.this.undo = true;
                AvlTreeActivity.this.rbt.startPositionX = (double) (((int) (((double) ((float) AvlTreeActivity.this.width)) * 0.9d)) / 2);
                if (AvlTreeActivity.this.rbt.root != null) {
                    AvlTreeActivity.this.rbt.root.resizeTree();
                    AvlTreeActivity.this.setWidth();
                    AvlTreeActivity.this.setDimension();
                }
            } catch (Exception e) {
    ...
    class InorderClass implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                ...
                AvlTreeActivity.this.rbt.inorder(rbt.root);
                check.setText("Inorder: ");

                for (AvlNode node : linkedList) {
                    check.append(node.data + " , ");
                }

                AvlTreeActivity.this.rbt.order();
                dt.resume();
                AvlTreeActivity.this.animate = false;
            } catch (Exception ex) {
                ex.printStackTrace();
    ...
    class PreOrder implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                ...
                AvlTreeActivity.this.rbt.preorder(rbt.root);
    ...
    class PostOrder implements OnClickListener {
        ...
        public void onClick(View arg0) {
            ...
            try {
                ...
                AvlTreeActivity.this.rbt.postorder(rbt.root);
...
//            AvlTreeActivity.this.startActivity(optionActivity);
        }
    }
    ...
    class C15308 implements OnFocusChangeListener {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (!hasFocus) {
                AvlTreeActivity.this.hideKeyboard(v);
            }
        }
    }
    ...
    public class DrawTree extends SurfaceView implements Runnable {
        ...
        class C15321 implements Runnable {
            ...
            public void run() {
                AvlTreeActivity.this.scroll.fullScroll(66);
            }
        }
        ...
        class ClassDown implements Runnable {
            ...
            public void run() {
                AvlTreeActivity.this.verticalScroll.fullScroll(66);
            }
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            setMeasuredDimension(AvlTreeActivity.this.width, AvlTreeActivity.this.height);
        }
            ...
            while (this.isRunning) {
                if (this.ourHolder.getSurface().isValid()) {
                    ...
                    try {
                        ...
                        if (AvlTreeActivity.this.rbt.root != null) {
                            que = new LinkedList();
                            que.add(AvlTreeActivity.this.rbt.root);
                            while (!que.isEmpty()) {
                                n = (AvlNode) que.peek();
                                ...
                                if (n.parent != null) {
                                    AvlTreeActivity.this.random.setARGB(MotionEventCompat.ACTION_MASK, 200, 120, 40);
                                    AvlTreeActivity.this.random.setStyle(Style.STROKE);
                                    if (i > AvlTreeActivity.this.slow) {
                                        canvas.drawLine((float) ((int) n.fx), (float) ((int) n.fy), (float) ((int) n.parent.fx), (float) ((int) n.parent.fy), AvlTreeActivity.this.line);
                                    } else {
                                        double pnx;
                                        double pny;
                                        tmp = (n.fx - n.oldX) / ((double) AvlTreeActivity.this.slow);
                                        if (n.fx == n.oldX && n.fy == n.oldY) {
                                            nx = n.oldX;
                                            ny = n.oldY;
                                        } else if (tmp == 0.0d || n.fx - n.oldX ==0) {
                                            nx = n.oldX;
                                            ny = n.oldY + (((double) i) * ((n.fy - n.oldY) / ((double) AvlTreeActivity.this.slow)));
                                        } else {
                                            m = (n.fy - n.oldY) / (n.fx - n.oldX);
                                            nx = n.oldX + (((double) i) * tmp);
                                            ny = ((n.oldX + ((double) ((int) (((double) i) * tmp)))) * m) + (n.oldY - (n.oldX * m));
                                        }
                                        double ptmp = (n.parent.fx - n.parent.oldX) / ((double) AvlTreeActivity.this.slow);
                                        if (n.parent.fx == n.parent.oldX && n.parent.fy == n.parent.oldY) {
                                            pnx = n.parent.oldX;
                                            pny = n.parent.oldY;
                                        } else if (ptmp == 0.0d || n.parent.fx - n.parent.oldX ==0) {
                                            pnx = n.parent.oldX;
                                            pny = n.parent.oldY + (((double) i) * ((n.parent.fy - n.parent.oldY) / ((double) AvlTreeActivity.this.slow)));
                                        } else {
                                        ...
                                        canvas.drawLine((float) ((int) nx), (float) ((int) ny), (float) ((int) pnx), (float) ((int) pny), AvlTreeActivity.this.line);
                        ...
                        if (AvlTreeActivity.this.rbt.root != null) {
                            ...
                            int ts;
                            int r;
                            if (AvlTreeActivity.this.animate) {
                                que = new LinkedList();
                                que.add(AvlTreeActivity.this.rbt.root);
                                while (!que.isEmpty()) {
                                    n = (AvlNode) que.peek();
                                    ...
                                    s = "" + n.data;
                                    ts = (int) AvlTreeActivity.this.white.measureText(s);
                                    r = circleSize;
//                                    if (35 < ts) {
//                                        r = (ts + 10) / 2;
//                                    }
                                    if (n == AvlTreeActivity.this.rbn && ((double) AvlTreeActivity.this.width) - AvlTreeActivity.this.rbn.oldX > ((double) (AvlTreeActivity.this.ScreenWidth / 2))) {
                                        AvlTreeActivity.this.scroll.smoothScrollTo(((int) AvlTreeActivity.this.rbn.oldX) - (AvlTreeActivity.this.ScreenWidth / 2), 0);
                                    } else if (n == AvlTreeActivity.this.rbn) {
                                        AvlTreeActivity.this.scroll.postDelayed(new C15321(), 100);
                                    }
                                    if (AvlTreeActivity.this.rbn != null && ((double) AvlTreeActivity.this.height) - AvlTreeActivity.this.rbn.fy <200 ) {
                                        AvlTreeActivity.this.verticalScroll.smoothScrollTo(0, height+2000);
//                                        BinarySearchTreeActivity.this.verticalScroll.fullScroll(ScrollView.F);

                                    } else if (AvlTreeActivity.this.rbn != null) {
                                        AvlTreeActivity.this.scroll.postDelayed(new ClassDown(), 100);
                                    }
                                    ...
                                    if (i > AvlTreeActivity.this.slow) {
                                        ...
                                        if (n.highlight) {
                                            n.highlight = false;
                                            canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) (r + sizeYellow), AvlTreeActivity.this.yellow);
                                        } else {
                                            canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) (r + sizewhite), AvlTreeActivity.this.white);
                                        }
                                        if (n.black == 1) {
                                            canvas.drawCircle((float) ((int) n.fx), (float) ((int) n.fy), (float) r, AvlTreeActivity.this.black);
                                        } else {
                                            canvas.drawCircle((float) ((int) n.fx), (float) ((int) n.fy), (float) r, AvlTreeActivity.this.red);
                                        }
                                        canvas.drawText(s, (float) ((int) n.fx), (float) ((int) n.fy + textY), AvlTreeActivity.this.white);
                                        AvlTreeActivity.this.animate = false;
                                        if (AvlTreeActivity.this.rbn != null && ((double) AvlTreeActivity.this.width) - AvlTreeActivity.this.rbn.oldX > ((double) (AvlTreeActivity.this.ScreenWidth / 2))) {
                                            AvlTreeActivity.this.scroll.smoothScrollTo(((int) AvlTreeActivity.this.rbn.oldX) - (AvlTreeActivity.this.ScreenWidth / 2), 0);
                                        } else if (AvlTreeActivity.this.rbn != null) {
                                            AvlTreeActivity.this.scroll.postDelayed(new C15332(), 100);
                                        }
...
//                                            BinarySearchTreeActivity.this.verticalScroll.fullScroll(ScrollView.FOCUS_DOWN);
                                        ...
                                        if (n.black == 1) {
                                            canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) r, AvlTreeActivity.this.black);
                                        } else {
                                            canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) r, AvlTreeActivity.this.red);
                                        }
                                        canvas.drawText(s, (float) ((int) n.oldX), (float) ((int) n.oldY + textY), AvlTreeActivity.this.white);
                                    } else {
                                        tmp = (n.fx - n.oldX) / ((double) AvlTreeActivity.this.slow);
                                        ...
                                        if (n.highlight) {
                                            n.highlight = false;
                                            canvas.drawCircle((float) ((int) nx), (float) ((int) ny), (float) (r + sizeYellow), AvlTreeActivity.this.yellow);
                                        } else {
                                            canvas.drawCircle((float) ((int) nx), (float) ((int) ny), (float) (r + sizewhite), AvlTreeActivity.this.white);
                                        }
                                        if (n.black == 1) {
                                            canvas.drawCircle((float) ((int) nx), (float) ((int) ny), (float) r, AvlTreeActivity.this.black);
                                        } else {
                                            canvas.drawCircle((float) ((int) nx), (float) ((int) ny), (float) r, AvlTreeActivity.this.red);
                                        }
                                        canvas.drawText(s, (float) ((int) nx), (float) ((int) ny + textY), AvlTreeActivity.this.white);
                                    }
                                    que.remove();
                                }
                                i++;
                                Thread.sleep((long) (100 - ((int) AvlTreeActivity.this.speed)));
                            } else {
                                AvlTreeActivity.this.random.setColor(-1);
//                                canvas.drawText(AvlTreeActivity.this.print, (float) (AvlTreeActivity.this.scroll.getScrollX() + 40), BitmapDescriptorFactory.HUE_ORANGE, AvlTreeActivity.this.random);
//                                canvas.drawText(AvlTreeActivity.this.print, (float) (AvlTreeActivity.this.scroll.getScrollX() + 40), 80.0f, AvlTreeActivity.this.printColor);
...
//                                        r = (ts + 10) / 2;
//                                    }
                                    if (n == AvlTreeActivity.this.rbn || n.highlight) {
                                        canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) (r + sizeYellow), AvlTreeActivity.this.yellow);
                                    } else {
                                        canvas.drawCircle((float) ((int) n.oldX), (float) ((int) n.oldY), (float) (r + sizewhite), AvlTreeActivity.this.white);
                                    }
...
//            if (AvlTreeActivity.this.saveIS != null) {
//                SaveState sr = (SaveState) AvlTreeActivity.this.saveIS.getParcelable("key");
//                AvlTreeActivity.this.rbt = sr.rbt;
//                AvlTreeActivity.this.rbn = sr.rbn;
//                AvlTreeActivity.this.print = sr.print;
//                AvlTreeActivity.this.undoStack = sr.undoStack;
//                int max = AvlTreeActivity.this.ss.getMax();
//                AvlTreeActivity.this.speed = (((double) AvlTreeActivity.this.ss.getProgress()) / ((double) max)) * 100.0d;
//                AvlTreeActivity.this.dt.resume();
//            }
            return null;
        }
...
//            AvlTreeActivity.this.relativeLayout1.removeView(this.progressBar);
            AvlTreeActivity.this.constraintLayout.removeView(this.progressBar);

        }

        protected void onPreExecute() {
            this.progressBar = new ProgressBar(AvlTreeActivity.this.thisAct, null, 16842874);
            this.progressBar.setIndeterminate(true);
            this.progressBar.setVisibility(View.VISIBLE);
            LayoutParams param = new LayoutParams(100, 100);
            param.addRule(13);
//            AvlTreeActivity.this.relativeLayout1.addView(this.progressBar, param);
//            AvlTreeActivity.this.setContentView(AvlTreeActivity.this.relativeLayout1);
            AvlTreeActivity.this.constraintLayout.addView(this.progressBar, param);
            AvlTreeActivity.this.setContentView(AvlTreeActivity.this.constraintLayout);
...
//        ImageView quesButton = (ImageView) findViewById(R.id.question);
        ...
        ss.setProgress(50);
        AvlTreeActivity.this.speed = (((double) 50) / ((double) AvlTreeActivity.this.ss.getMax())) * 100.0d;


        this.editText1 = (EditText) findViewById(R.id.number);
        this.rbt = new AvlTree(this);
...
//        ((InputMethodManager) getSystemService("input_method")).hideSoftInputFromWindow(view.getWindowToken(), 0);
    ...
    public void undo() {
        ...
        this.rbt = (AvlTree) this.undoStack.pop();
        this.rbt.rbta = this;
    }
...
//        this.printColor.setStrokeWidth(15);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(AvlTreeActivity.this, HomeActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent intent = new Intent(AvlTreeActivity.this, AVLCode.class);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(AvlTreeActivity.this, AVLDetails.class);
            startActivity(intent);
            finish();
